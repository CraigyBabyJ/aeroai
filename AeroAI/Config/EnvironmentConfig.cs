...
public static class EnvironmentConfig
{
	...
	{
		return Environment.GetEnvironmentVariable("OPENAI_MODEL") ?? "ft:gpt-4o-mini-2024-07-18:personal:aeroai-v3:Cm6OllUu";
	}
	...
	{
		// Use compressed prompt for fine-tuned model by default
		return Environment.GetEnvironmentVariable("AEROAI_SYSTEM_PROMPT_PATH") ?? "prompts/aeroai_finetuned_prompt.txt";
	}
