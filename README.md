...
4) (Optional) Enable OpenAI TTS by setting `AEROAI_TTS_ENABLED=true` and OpenAI voice vars; edit `voices/*.json` and `Config/audio-effects.json` to tune radio effects and profiles.
